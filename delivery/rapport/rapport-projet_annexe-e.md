### Annexe E - Installation Projet et configuration de l'EDI

Voici l'ensemble des commandes à réaliser pour installer un projet, puis à configurer l'interpréteur de l'EDI en vue de 
coder le projet avec plus de facilité.
...
> ℹ️ **Note** : Les étapes sont détaillées pour l'EDI PyCharm qui est utilisé pour le développement du projet. Pour 
> l'EDI VSC, cette configuration est aussi nécessaire et se trouve développée succinctement dans la section suivante.
