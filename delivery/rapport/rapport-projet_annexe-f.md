### Annexe F – Main‑courante technique et difficultés

> Cette annexe reprend les sections 9 et 10 du document `devMC.md` afin de conserver une trace détaillée des difficultés 
> rencontrées et des décisions prises au cours du projet.
> 
>> - Section 9 : Difficultés rencontrées (authentification, sécurité, logs, routage…)
>> - Section 10 : Décisions et arbitrages techniques (organisation des templates, séparation des rôles, conventions de 
> tests…)
...
De ces lectures, j'ai créé un [_memento_](../../docs/technique/Memento_Django-Balises-Filtres.md) pour une exploitation dans 
mon développement.
...
Le cycle de vie métier, modélisé dans le document d'analyse du cycle de vie d'un média ([devALCBibMedias.md](../../docs/developpement/dev-docs/assets/technique/devALCBibMedias.md)), 
...
3. **Documentation** :  
   - Rédaction du document [devALCBibMedias.md](../../docs/developpement/dev-docs/assets/technique/devALCBibMedias.md) 
   pour formaliser les états, transitions, et impacts techniques.
   - Intégration dans le [Plan de tests](../../docs/developpement/dev-docs/devTests.md) (`T-FUN-xx` à `T-FUN-yy`) pour 
   valider les transitions métier.

   > Le document [devALCBibMedias.md](../../docs/developpement/dev-docs/assets/technique/devALCBibMedias.md) défini les 
   > principes retenus pour le développement et les tests dans l'ensemble du projet, alors que le 
   > [Plan de tests](../../docs/developpement/dev-docs/devTests.md) décrits les tests mis en œuvre.  
...
Après la validation du cycle de vie des entités `Media` dans 
[`devALCBibMedias.md`](../../docs/developpement/dev-docs/assets/technique/devALCBibMedias.md), il est apparu nécessaire 
de formaliser **les interactions métier entre les entités `Media`, `Membre`, et `Emprunt`** avant de poursuivre le 
développement des fonctionnalités associées aux UC-MEMBRE et UC-EMPRUNT.

#### b) Résolution adoptée

Cette difficulté a conduit à la rédaction d’un document transversal :

➡️ Analyse du cycle de vie des entités de Bibliothécaire : [`devALCBib.md`](../../docs/developpement/dev-docs/devALCBib.md)
...
le [plan de tests](../../docs/developpement/dev-docs/devTests.md).  
...
- La documentation fonctionnelle de Bibliothecaire ([devAFBib](../../docs/developpement/dev-docs/devAFBib.md)) ne 
prévoyait initialement pas de section dédiée aux méthodes métier.
...
- Révision de l’analyse fonctionnelle Bibliothécaire ([devAFBib](../../docs/developpement/dev-docs/devAFBib.md)) pour 
intégrer ces méthodes dans les UC, sans détailler leur logique interne.
- Alignement avec les DDM et vecteurs d’état définis dans le cycle de vie des entités 
([devALCBib](../../docs/developpement/dev-docs/devALCBib.md)).
...
- L'analyse fonctionnelle Bibliothécaire ([devAFBib](../../docs/developpement/dev-docs/devAFBib.md)) doit prévoir une 
annexe “Méthodes métier par entité” ou les intégrer directement dans les UC.
...
les prémisses de l’issue #6, qui vise à compléter les tests fonctionnels développés selon 
l’[devAFBib](../../docs/developpement/dev-docs/devAFBib.md) et le [plan de tests](../../docs/developpement/dev-docs/devTests.md).
...
- Exemple 1 : [marquage automatique à la première connexion (message et tableau affichés)](../../docs/developpement/dev-docs/devAFBib.md#-marquage-automatique---exemple-dux-obtenus-avec-le-scenario-scenar_01)
- Exemple 2 : [marquage manuel via commande dédiée (message injecté, tableau affiché)](../../docs/developpement/dev-docs/devAFBib.md#-marquage-manuel---exemple-dux-obtenus-avec-le-scenario-scenar_01)
...
[section 3.5 de l'Analyse des Fonctionnalités](../../docs/developpement/dev-docs/devAFBib.md#35-gestion-des-logs--fonction-transversale)) :
