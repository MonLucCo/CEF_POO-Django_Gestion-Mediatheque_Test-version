...
class MediaEntityTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.monMedia = Media.objects.create(titre="Test Media", annee_edition=0, media_type="LIVRE", theme="Test Theme Media")

    def test_ent_01_media_livre_creation(self):
        self.assertEqual(self.monMedia.titre, "Test Media")
    ...
    def test_ent_03_media_sans_sous_type(self):
        ...
        self.assertTrue(hasattr(self.monMedia, 'titre'))
    ...
    def test_ent_04_media_avec_sous_type(self):
        ...
        monLivre = Livre.objects.create(
            titre=titreLivre, annee_edition=1, media_type="LIVRE", theme="Test Theme Media-Livre",
        ...
        self.assertEqual(Media.objects.get(pk=1).titre, "Test Media")
        self.assertEqual(Media.objects.get(pk=2).titre, titreLivre)
        ...
        self.assertEqual(Livre.objects.get(pk=2).titre, titreLivre)
